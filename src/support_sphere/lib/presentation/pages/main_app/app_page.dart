  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocBuilder<AppBloc, AppState>(
        buildWhen: (previous, current) => previous.selectedBottomNavIndex != current.selectedBottomNavIndex,
          ...
          return SafeArea(
            child: Scaffold(
              appBar: AppBar(
                ...
                // actions: [
                //   IconButton(
                //     icon: const Badge(label: Text('2'), child: Icon(Ionicons.notifications_sharp)),
                //     color: Colors.white,
                //     onPressed: () {},
                //   ),
                // ],
              ...
              bottomNavigationBar: NavigationBar(
                  ...
                  onDestinationSelected: (value) {
                    context.read<AppBloc>().add(AppOnBottomNavIndexChanged(value));
                  },
                  destinations: [for (final destination in AppBodySelect.destinations)
