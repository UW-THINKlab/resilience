...
class ChecklistCubit extends Cubit<ChecklistState> {
  ...
  Future<void> updateStepStatus(
      String stepStateId, bool isCompleted, String userChecklistId) async {
    ...
    try {
      ...
      final allCompleted = await _checklistRepository.areAllStepsCompleted(
          userChecklistId, authUser.uuid);

      await _checklistRepository.updateChecklistCompletedAt(
          userChecklistId, allCompleted ? DateTime.now() : null);
