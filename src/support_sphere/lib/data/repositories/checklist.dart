...
class ChecklistRepository {
  ...
  Future<List<UserChecklist>> getUserChecklistsByUserId(String userId) async {
    ...
    return data.map((item) {
      ...
      return UserChecklist(
        ...
        steps: steps
            ?.map<UserChecklistSteps>(
              (step) => UserChecklistSteps(
                id: step['id'],
                ...
                updatedAt: DateTime.parse(
                  step['checklist_steps']['updated_at'],
                ),
              ),
            )
            .toList(),
  ...
  Future<bool> areAllStepsCompleted(
    String userChecklistId,
    String userId,
  ) async {
    return await _checklistService.areAllStepsCompleted(
      userChecklistId,
      userId,
    );
  }
  ...
  Future<void> updateChecklistCompletedAt(
    ...
    await _checklistService.updateChecklistCompletedAt(
      userChecklistId,
      completedAt,
    );
  }
  ...
  Future<List<Checklist>> getAllChecklists() async {
    ...
    return data.map((item) {
      ...
      final completions =
          (item['user_checklists'] as List<dynamic>?)
  ...
  Future<void> deleteChecklistSteps(
    String checklistId,
    List<String> stepIds,
  ) async {
