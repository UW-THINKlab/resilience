...
import 'package:support_sphere/presentation/pages/main_app/manage_user_roles/manage_user_roles_body.dart';
  ...
  static List<AppRoute> getDestinations(String? role, [double? minWidth]) {
    ...
    if (role == AppRoles.communityAdmin && minWidth! > 641) {
      destinations = destinations + [
        ...
        const AppRoute(
            icon: Icon(Ionicons.people_sharp), label: NavRouteLabels.manageUserRoles, body: ManageUserRolesBody()),
      ];
    }
    return destinations;
  }
